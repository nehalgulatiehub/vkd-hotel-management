...
export const ADMIN_USER_MENU_ITEMS: AdminUserMenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "booking_section_visa", label: "Visa" },
      { key: "booking_section_cruise", label: "Cruise" },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { key: "payments_visa", label: "View Visa Detail" },
      { key: "payments_visa_due", label: "Visa Due Amount" },
      { key: "payments_visa_payment", label: "View Visa Payment" },
      { key: "payments_cruise", label: "View Cruise Detail" },
      { key: "payments_cruise_due", label: "Cruise Due Amount" },
      { key: "payments_cruise_payment", label: "View Cruise Payment" },
