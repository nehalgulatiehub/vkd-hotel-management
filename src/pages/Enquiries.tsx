...
export default function Enquiries() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const enquiryData = {
      ...
      booking_hotel_id: formData.booking_hotel_id,
      booking_room: formData.booking_room,
      booking_num_rooms: formData.booking_num_rooms,
      booking_package_type: formData.booking_package_type,
      booking_custom_package: formData.booking_custom_package,
      booking_price: formData.booking_price,
      booking_from: formData.booking_from,
      booking_to: formData.booking_to,
      dm_num_tickets: formData.dm_num_tickets,
      dm_ticket_no: formData.dm_ticket_no,
      dm_seat_no: formData.dm_seat_no,
      dm_transporter_id: formData.dm_transporter_id,
      dm_booking_date: formData.dm_booking_date,
      dm_journey_date: formData.dm_journey_date,
      dm_booking_price: formData.dm_booking_price,
      dm_selling_price: formData.dm_selling_price,
      md_num_tickets: formData.md_num_tickets,
      md_ticket_no: formData.md_ticket_no,
      md_seat_no: formData.md_seat_no,
      md_transporter_id: formData.md_transporter_id,
      md_booking_date: formData.md_booking_date,
      md_journey_date: formData.md_journey_date,
      md_booking_price: formData.md_booking_price,
      md_selling_price: formData.md_selling_price,
      safari_transporter_id: formData.safari_transporter_id,
      safari_num: formData.safari_num,
      safari_booking_date: formData.safari_booking_date,
      safari_journey_date: formData.safari_journey_date,
      safari_booking_price: formData.safari_booking_price,
      safari_selling_price: formData.safari_selling_price,
      safari_note: formData.safari_note,
      another_hotel_id: formData.another_hotel_id,
      another_hotel_num_rooms: formData.another_hotel_num_rooms,
      another_hotel_room_type: formData.another_hotel_room_type,
      another_hotel_booking_date: formData.another_hotel_booking_date,
      another_hotel_check_in: formData.another_hotel_check_in,
      another_hotel_check_out: formData.another_hotel_check_out,
      another_hotel_booking_price: formData.another_hotel_booking_price,
      another_hotel_selling_price: formData.another_hotel_selling_price,
      another_hotel_note: formData.another_hotel_note,
      vehicle_details: formData.vehicle_details,
      vehicle_booking_price: formData.vehicle_booking_price,
      vehicle_selling_price: formData.vehicle_selling_price,
      vehicle_transporter_id: formData.vehicle_transporter_id,
      vehicle_booking_date: formData.vehicle_booking_date,
      vehicle_journey_date: formData.vehicle_journey_date,
      vehicle_note: formData.vehicle_note,
      group_expense_amount: formData.group_expense_amount,
      group_expense_details: formData.group_expense_details,
      status: "on_hold"
    };
