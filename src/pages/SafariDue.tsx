                  ...
                  {filteredBookings.length === 0 ? (
                    ...
                    filteredBookings.map((booking, index) => (
                      <tr key={booking.id} style={{ backgroundColor: "#F5E6E0" }}>
                        ...
                        <td className="border border-[#c99] px-3 py-2 text-xs align-top">
                          <div><strong>Persons:</strong> {booking.number_of_persons || 1}</div>
                        ...
                        <td className="border border-[#c99] px-3 py-2 text-xs align-top">
                          <div><strong>Safari:</strong> {booking.safari_date ? new Date(booking.safari_date).toLocaleDateString("en-GB") : "-"}</div>
                        </td>
                        <td className="border border-[#c99] px-3 py-2 align-top">
                          <div className="flex flex-col gap-0.5">
                            ...
                            <Button size="sm" variant="link" className="h-auto p-0 text-[11px] text-primary justify-start" onClick={() => navigate(`/safari-payments?booking_id=${booking.bookings?.id}`)}>Add Payment</Button>
                          </div>
                        </td>
                      </tr>
                    ))
