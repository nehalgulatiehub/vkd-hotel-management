      ...
      <main className="p-2">
        ...
        <div className="mt-2 overflow-x-auto">
            ...
            <table className="w-full text-[11px] border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#D4A59A" }}>
                  ...
                  <th className="border border-[#c99] px-2 py-1.5 text-left font-semibold">D - M Volvo Detail</th>
          ...
          {!loading && filteredBookings.length === 0 && (
            <div className="text-center py-8 text-muted-foreground">No Delhi-Manali volvo bookings found</div>
          )}
        </div>
