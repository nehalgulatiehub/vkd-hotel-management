        ...
        <Card>
          <CardHeader className="py-2 px-4 border-b bg-destructive/10">
            <CardTitle className="text-sm flex items-center justify-between">
              <span className="flex items-center gap-2"><Clock className="h-4 w-4" /> Vehicle Pending Payments ({totalItems})</span>
          ...
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">No pending vehicle payments found.</div>
            ) : (
              <>
