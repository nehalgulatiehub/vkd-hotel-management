...
export default function AdminAddTransporterPayment() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Transporter payment added successfully");
      handleReset();
    } catch (error) {
  ...
  if (authLoading) {
    return (
      <div className="min-h-screen">
        <AdminHeader title="Add Transporter Payment" />
  ...
  return (
    <div className="min-h-screen">
      <AdminHeader title="Add Another Vehicle Transporter Payment" />
      <main className="p-4">
        <div className="flex justify-end mb-2">
          <Button 
            variant="outline" 
            size="sm"
            onClick={() => navigate("/admin/vehicle-pending")}
            className="text-xs"
          >
            Manage Transporter Payment
          </Button>
        </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 bg-white">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                <label className="w-32 text-right text-sm">Transporter</label>
