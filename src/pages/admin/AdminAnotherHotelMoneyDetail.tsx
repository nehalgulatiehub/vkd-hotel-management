    ...
    <div className="min-h-screen bg-background">
      <main className="p-2">
        <div className="flex justify-between items-center mb-2 px-3 py-2" style={{ backgroundColor: "#1e6e99" }}>
          <h2 className="text-white font-semibold text-sm">View Another Hotel Money Detail</h2>
          ...
          <div className="p-2 bg-white space-y-2">
            ...
            <div className="flex flex-wrap items-center gap-4 text-xs">
              <div className="flex items-center gap-1">
                ...
                <select value={hotelId} onChange={(e) => setHotelId(e.target.value)} className="border px-1 py-0.5 text-xs min-w-[250px]">
            ...
            <table className="w-full text-[11px] border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#D4A59A" }}>
                  ...
                  <th className="border border-[#c99] px-2 py-1.5 text-left font-semibold">Customer</th>
                  <th className="border border-[#c99] px-2 py-1.5 text-left font-semibold">Hotel</th>
                  <th className="border border-[#c99] px-2 py-1.5 text-left font-semibold">Another Hotel Journey Date</th>
              ...
              <tbody>
                {paginatedItems.map((booking, idx) => (
                  <tr key={booking.id} style={{ backgroundColor: "#F5E6E0" }}>
                    ...
                    <td className="border border-[#c99] px-2 py-2">{booking.hotel?.name || "-"}</td>
                    <td className="border border-[#c99] px-2 py-2">
                      {booking.check_in_date ? format(new Date(booking.check_in_date), "dd/MM/yyyy") : "-"}
                    </td>
                    <td className="border border-[#c99] px-2 py-2">
                      Another Hotel Booking Price : Rs {(booking.total_amount || 0).toLocaleString('en-IN')} /-
                    </td>
                    <td className="border border-[#c99] px-2 py-2">
