  ...
  if (authLoading) {
    return (
      <div className="min-h-screen">
        <AdminHeader title="Delhi-Manali Due Amount" />
        <main className="p-4">
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="p-4">
        ...
        <div className="flex justify-between items-center px-4 py-2 mb-3" style={{ backgroundColor: "#1e6e99" }}>
          <span className="text-white font-semibold text-sm">Delhi-Manali Volvo Due Amount</span>
          <Button variant="link" className="text-white p-0 h-auto text-sm hover:text-white/80" onClick={() => navigate("/admin/volvo-delhi-manali")}>
            View All Records
          </Button>
        </div>
        ...
        <Card>
          <CardContent className="p-0">
            {loading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">No Delhi-Manali due amounts found</div>
            ) : (
              <>
