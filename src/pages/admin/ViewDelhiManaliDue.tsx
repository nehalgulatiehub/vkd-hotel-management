        ...
        <div className="flex flex-wrap items-center gap-x-6 gap-y-1">
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="h-7 text-xs border border-gray-300 rounded px-2 bg-white min-w-[200px]"
            >
                ...
                filteredSummaries.map((summary, index) => (
                  <tr key={summary.transporter_id} className={index % 2 === 0 ? "bg-[#f6f0f0]" : "bg-white"}>
                    ...
                    <td className="border border-gray-300 px-2 py-1.5 text-center">
                      <button onClick={() => navigate(`/admin/dm-transporter-money?transporter=${summary.transporter_id}`)} className="text-blue-600 hover:underline text-xs">View</button>
                    </td>
                  </tr>
                ))
              )}
