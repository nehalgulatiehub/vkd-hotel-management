  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="p-4 space-y-4">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Manali-Delhi Due Amount - Total: ₹{totalDue.toLocaleString()}</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mb-4">
            ...
            {loading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">No Manali-Delhi dues found.</div>
            ) : (
              <>
                <Table>
                  <TableHeader>
