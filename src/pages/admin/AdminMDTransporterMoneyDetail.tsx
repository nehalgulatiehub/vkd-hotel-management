    ...
    <div className="min-h-screen bg-background">
      <main className="p-2">
        <div className="flex justify-between items-center mb-2 px-3 py-2" style={{ backgroundColor: "#1e6e99" }}>
          <h2 className="text-white font-semibold text-sm">View M-D Transporter Money Detail</h2>
        ...
        <div className="overflow-x-auto">
            ...
            <table className="w-full text-[11px] border-collapse">
              <thead>
                <tr style={{ backgroundColor: "#D4A59A" }}>
                  ...
                  <th className="border border-[#c99] px-2 py-1.5 text-left font-semibold">M- D Volvo Journey Date</th>
          ...
          {!loading && filteredBookings.length === 0 && (
            <div className="text-center py-8 text-muted-foreground">No M-D volvo bookings found</div>
          )}
        </div>
