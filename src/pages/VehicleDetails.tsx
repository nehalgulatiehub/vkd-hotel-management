...
export default function VehicleDetails() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="p-6">
        <div className="mb-6">
          <h2 className="text-2xl font-semibold">View Vehicle Details</h2>
        </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b">
                    ...
                    <th className="text-left p-4 font-semibold">Vehicle No</th>
                ...
                <tbody>
                  {filteredBookings.map((booking) => (
                    <tr key={booking.id} className="border-b hover:bg-muted/50">
                      ...
                      <td className="p-4 capitalize">{booking.vehicle_type?.replace("_", " ") || "-"}</td>
