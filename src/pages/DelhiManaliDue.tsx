    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="p-4">
        ...
        <div className="flex justify-between items-center px-4 py-2 mb-3" style={{ backgroundColor: "#1e6e99" }}>
          <span className="text-white font-semibold text-sm">Delhi - Manali Due Amount</span>
        ...
        <Dialog open={showViewDetailDialog} onOpenChange={setShowViewDetailDialog}>
          <DialogContent className="max-w-lg p-0 overflow-hidden">
            <div className="px-4 py-2" style={{ backgroundColor: "#1e6e99" }}>
              <DialogTitle className="text-white text-sm font-semibold">Delhi-Manali Booking Details</DialogTitle>
            </div>
            {selectedBooking && (
              <div className="p-4" style={{ backgroundColor: "#FDE1E1" }}>
                <table className="w-full text-xs border-collapse">
                  <tbody>
                    ...
                    <tr className="border-b border-[#FFC1C1]"><td className="py-1.5 font-semibold">Route</td><td className="py-1.5">Delhi - Manali</td></tr>
